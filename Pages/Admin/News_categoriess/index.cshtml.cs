...
namespace MyOrangeCMS_RazorVersion.Pages.Admin.News_categoriess
{
    ...
    public class IndexModel : BasePageModel
    {
        ...
        public IList<News_categoriesDTO> News_categories { get;set; } = default!;
        ...
        public async Task OnPostAsync()
        {
            ...
            if (_context.News_categories != null)
            {
                ...
                this.News_categories   = _mapper.Map<List<News_categoriesDTO>>(lst);
        ...
        public async Task OnGetAsync()
        {
            ...
            if (_context.News_categories != null)
            {
                TotalCount   = await _context.News_categories.CountAsync();
                var lst      = await _context.News_categories.OrderByDescending(x => x.Id).Take(MyPage.PageSize).ToListAsync();
