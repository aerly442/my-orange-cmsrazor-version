using System;
 ...
 namespace MyOrangeCMS_RazorVersion.Pages.Admin.News_comments
 {
      public class IndexModel : BasePageModel
     {
        ...
        public IList<News_commentDTO> News_comment { get;set; } = default!;
        ...
        public async Task OnPostAsync()
        {
            ...
            if (_context.News_comment != null)
            {
                ...
                this.News_comment  = _mapper.Map<List<News_commentDTO>>(lst);
        ...
        public async Task OnGetAsync()
        {
            ...
            if (_context.News_comment != null)
            {
                TotalCount   = await _context.News_comment.CountAsync();
                var lst      = await _context.News_comment.OrderByDescending(x => x.Id).Take(MyPage.PageSize).ToListAsync();
