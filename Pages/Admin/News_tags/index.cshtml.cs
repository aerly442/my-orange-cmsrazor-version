...
namespace MyOrangeCMS_RazorVersion.Pages.Admin.News_tags
{
    ...
    public class IndexModel : BasePageModel
    {
        ...
        private readonly News_tagService _news_TagService;
        public IndexModel(MyOrangeCMS_RazorVersionContext context,
            News_tagService news_TagService,
            IMapper mapper)
        {
            _context = context;
            _mapper  = mapper;
            _news_TagService = news_TagService ;
     
        }

        public IList<News_tagDTO> News_tag { get;set; } = default!;
        ...
        public async Task OnPostAsync()
        {
            ...
            if (_context.News_tag != null)
            {
                ...
                this.News_tag      = _mapper.Map<List<News_tagDTO>>(lst);
        ...
        public async Task OnGetAsync()
        {
            ...
            if (_context.News_tag != null)
            {
                TotalCount   = await _context.News_tag.CountAsync();
                var query    = this._news_TagService.GetQuery();
