...
namespace MyOrangeCMS_RazorVersion.Pages.Admin.News_resources
{
    ...
    public class IndexModel : BasePageModel
    {
        ...
        public IList<News_resourceDTO> News_resource { get;set; } = default!;
        ...
        public async Task OnPostAsync()
        {
            ...
            if (_context.News_resource != null)
            {
                ...
                this.News_resource   = _mapper.Map<List<News_resourceDTO>>(lst);
        ...
        public async Task OnGetAsync()
        {
            ...
            if (_context.News_resource != null)
            {
                TotalCount   = await _context.News_resource.CountAsync();
                var lst      = await _context.News_resource.OrderByDescending(x => x.Id).Take(MyPage.PageSize).ToListAsync();
