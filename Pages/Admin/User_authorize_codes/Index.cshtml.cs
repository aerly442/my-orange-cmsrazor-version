    ...
    public class IndexModel : BasePageModel
     {
         ...
         public IndexModel(MyOrangeCMS_RazorVersionContext context, IMapper _mapper)
         {
             _context     = context;
             this._mapper = _mapper;
         }
        
        public IList<User_authorize_codeDTO> User_authorize_code { get;set; } = default!;
        ...
        public async Task OnPostAsync()
        {
            ...
            if (_context.User_authorize_code != null)
            {
                ...
                this.User_authorize_code     = _mapper.Map<List<User_authorize_codeDTO>>(lst);
        ...
        public async Task OnGetAsync()
        {
            ...
            if (_context.User_authorize_code != null)
            {
                TotalCount   = await _context.User_authorize_code.CountAsync();
                var lst      = await _context.User_authorize_code.OrderByDescending(x => x.Id).Take(MyPage.PageSize).ToListAsync();
