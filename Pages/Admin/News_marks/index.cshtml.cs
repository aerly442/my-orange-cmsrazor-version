...
namespace MyOrangeCMS_RazorVersion.Pages.Admin.News_marks
{
    ...
    public class IndexModel : BasePageModel
    {
        ...
        public IList<News_markDTO> News_mark { get;set; } = default!;
        ...
        public async Task OnPostAsync()
        {
            ...
            if (_context.News_mark != null)
            {
                ...
                this.News_mark   = _mapper.Map<List<News_markDTO>>(lst);
        ...
        public async Task OnGetAsync()
        {
            ...
            if (_context.News_mark != null)
            {
                TotalCount   = await _context.News_mark.CountAsync();
                var lst      = await _context.News_mark.OrderByDescending(x => x.Id).Take(MyPage.PageSize).ToListAsync();
